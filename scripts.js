...
class RocketLauncher {
   constructor(checkSystems, fuelQuantity) {
   ...
   rocketPreparation () {
      this.fuelQuantity = 0;
      this.rocketRefueling(this.fuelQuantity);
      ...
      textBlock.innerHTML = "";
         setInterval( () => {
            ...
            if (this.fuelQuantity === 100) {
               clearInterval (this.fuelQuantity === 100);
...
startBtn.onclick = () => {
   ...
   visualBlock.innerHTML += "<h2>CONGRATULATIONS! The rocket was successfully launched.</h2>";
}
